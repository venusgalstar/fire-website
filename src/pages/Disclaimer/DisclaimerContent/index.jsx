...
const DisclaimerContent = () => {
    const [current_users, setCurrent_users] = useState(0)
    ...
    const getUsersCount = () => {
        ...
        fetch('https://phoenix-statistics.herokuapp.com/get_count', requestOptions)
            ...
            .then(data => setCurrent_users(data.count));
    }
        ...
        <section style={{ maxWidth: '1150px', margin: '0 auto' }}>
            <div>
                <div className="disclaim-content">
                    ...
                    <p>The current token reward system is {contractValues.nestRewardRate} $FIRE per NEST per day. The Founders and extended management reserve the right to amend the rate should the need of the protocol require.</p>
            ...
            <siv className="c-w flex flex-col align-center" style={{ marginTop: "60px", marginBottom: "60px" }}>
                <Button type="primary">
                    Current Nest Holders : {current_users}
                </Button>
            </siv>
        </section>
    );
